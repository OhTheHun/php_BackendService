...
return [
    ...
    'title' => 'JotDown API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API documentation for the JotDown backend service.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Use the JWT returned by the login or register endpoint as a Bearer token.',
    ],
